...
# # IT WAS USED IN PHASE I OF THIS PROJECT USING (NOW DEPRECATED) ROUTINES
# # FOR A REIMPLEMENTATION WITH UPDATED ROUTINES, see trial-patter-2.R
# # THIS VERSION IS KEPT BECAUSE PHASE I INSIGHTS (COMMENTS) WERE USEFUL 
# 
# #### Aims
