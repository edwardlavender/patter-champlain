...
tmp     <- patter::map_pou(map, it_states)$ud
...
# * callstats   : 0.00209  
# * diagnostics : 1.071778
# * jld2 files  : 1428.534
# * states      : 927.1699
# * map         : 0.036435
# * Total       : 928.2802
#   (excluding jld2 files, which we delete)
# To store the outputs of the real world analysis, we would need 2527.707 GB
...
# - (0.00209 + 1.071778 + 0.036435) * 2723 = 3023.355 MB (real-world analysis)
