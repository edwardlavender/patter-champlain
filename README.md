Estimating residency in acoustic telemetry systems
================
Edward Lavender\*
...
Follow the instructions in `dev/02-clone.R` to install packages and
directories:
    ...
    -   **Directories.** Rebuild the project directory tree, via `proj.templates::use_template_proj()` and `proj.templates::use_template_tree()`.
